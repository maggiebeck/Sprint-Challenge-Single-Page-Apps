...
> Answer: After the first time the page loads, the user will be able to use and interact with the page faster.
- [ ] What does AJAX stand for?
> Answer: Asynchronious Javascript And XML
- [ ] What are `controlled components` in React?
> Answer: Functions that handle form submissions and house the data submitted in the form.
